...
public class GeneAssociationSummaryTest {
    ...
    public GeneAssociationSummaryTest() {
        ...
        summary = new AssociationSummary(true, true, true,"14q23.1", 89.00, 78.01);
    ...
    public void testToString() {
        String expResult = "GeneAssociationSummary{ FGFR2{HGNC:46785} Fgfr2{MGI:1234} AssociationSummary{associatedInHuman=true, hasLiteratureEvidence=true, inLocus=true, locus=14q23.1, bestMgiScore=89.0, bestImpcScore=78.01}}";
