...
public class DiseaseDaoImplTest {
    ...
    @Autowired
    private static TestDiseaseDao testDiseaseDao;

    
    public DiseaseDaoImplTest() {
    }
    ...
    public void testGetDiseaseByOmimDiseaseId() {
        ...
        testDiseaseDao = TestDiseaseDao.getInstance();
    ...
    public void testGetDiseaseByOmimGeneId() {
        ...
        TestDiseaseDao instance = TestDiseaseDao.getInstance();
...
//        assertEquals(expResult, result);
    ...
    public void genePageIntegrationTest(){
        ...
        DiseaseDao diseaseDao = TestDiseaseDao.getInstance();
