...
<html>
    <head>
        ...
        <link type="text/css" rel="stylesheet" href="d3/test.css"/>
        <link type="text/css" rel="stylesheet" href="https://www.mousephenotype.org/data/css/bootstrap.css"/>
        <link type="text/css" rel="stylesheet" href="https://www.mousephenotype.org/data/css/custom.css"/>
        <script type="text/javascript" src=<c:url value="/js/d3/d3.v3.js"/>></script>
        <script type="text/javascript" src="${baseUrl}/js/3/d3.layout.js"></script>
        <style type="text/css">
            .node circle {
                cursor: pointer;
                fill: #fff;
    ...
    <div class="row-fluid dataset">
        ...
        <script type='text/javascript' src="${baseUrl}/js/helloWorld.js"></script>
    </div>
  ...
  <script type='text/javascript' src=<c:url value="/js/graphs/arbor/arbor.js"/>></script>  

  <script type='text/javascript' src=<c:url value="/js/graphs/arbor/main.js"/>></script>
